...
class AIBot:
    ...
    def invoke(self, history_messages, question):
        ...
        Você é um assistente especializado em tirar dúvidas dos clientes de topo do funil da Beehouse Investimentos Imobiliários.
        Tire dúvidas dos possíveis clientes que entrarem em contato.
